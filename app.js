...
const institutions = [
  ...
  },
  {
    ...
    veiculo: "Sim",
    recepcao: "Precisa melhorar",
    proxima: "Sim",
    positivo: "A oportunidade da nossa Fanfarra prestigiar o evento. Todas as informações foram a contento.",
  ...
  },
  {
    ...
    recepcao: "Precisa melhorar",
    proxima: "Sim",
    positivo: "Todo processo de organização e acolhimento.",
  ...
  },
  {
    ...
    recepcao: "Satisfatório",
    proxima: "Sim",
    positivo: "As músicas, a banda de fanfarra e a segurança durante a caminhada",
  ...
  },
  {
    ...
    recepcao: "Não",
    proxima: "Sim",
    positivo: "As crianças realizarem a caminhada chamando atenção para uma temática importante relacionada a elas",
    melhoria: "Pulseiras entregues diretamente às equipes para os próprios profissionais distribuírem.",
  ...
  },
  {
    ...
    recepcao: "Satisfatório",
    proxima: "Sim",
    positivo: "As informações a respeito do ECA e a atenção dos conselheiros",
  ...
  },
  {
    ...
    recepcao: "Boa",
    proxima: "Sim",
    positivo: "A alegria de nossas crianças em poder compartilhar espaços diferentes em sua trajetória educacional.",
    melhoria: "Melhorar a divulgação e assistência às crianças com mais dignidade, principalmente em instalações sanitárias.",
